...
export const SideTable = ({
  ...
  return (
    <div className="flex flex-col justify-between border-r border-t border-gray-200 max-w-[250px] w-full flex-shrink-0 flex-grow">
      <div>
        ...
        <ul>
          {list.map((item) => (
            <li
              key={item.id}
              className="group transition duration-300 flex items-center justify-between pl-[14px] pr-2 py-2 border-b border-gray-200 hover:bg-green-100/10 cursor-pointer"
            >

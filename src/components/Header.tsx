...
export const Header = ({ lang }: Language) => {
  ...
  //     <div
  //       className={twMerge(
  //         "absolute pt-24 px-4 inset-0 lg:pt-0 h-0 lg:h-auto opacity-0 bg-white lg:relative lg:mr-auto transition-all duration-300",
  ...
  //     <div className="z-50 flex gap-8 2xl:gap-[50px] items-center">
  //       <LanguageSwitcher />
